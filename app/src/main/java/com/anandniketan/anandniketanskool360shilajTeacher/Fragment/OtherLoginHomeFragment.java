...
import com.anandniketan.anandniketanskool360shilajTeacher.Adapter.otherLoginImageAdapter;
...
public class OtherLoginHomeFragment extends Fragment {
    ...
    public OtherLoginHomeFragment() {
    }

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.fragment_other_login_home, container, false);
    ...
    public void initViews() {
        ...
        grid_view.setAdapter(new otherLoginImageAdapter(mContext));
