...
public class StudentAbsentFragment extends Fragment implements DatePickerDialog.OnDateSetListener {
    ...
    private Button btnBacktest_student_absent, btnLogout;
    ...
    private GetStudentAbModel getStudentAbModelresponse;
...
//                        getStudentAbModelresponse = getConsistentAbAsyncTask.execute().get();
//                        getActivity().runOnUiThread(new Runnable() {
//                            @Override
//                            public void run() {
//                                progressDialog.dismiss();
//                                if (getStudentAbModelresponse.getFinalArray().size() > 0) {
//                                    txtNoRecordsstudentabsent.setVisibility(View.GONE);
//                                    student_absent_header.setVisibility(View.VISIBLE);
//                                    studentAbsentListAdapter = new StudentAbsentListAdapter(getActivity(), getStudentAbModelresponse, new getCheckconsistentAb() {
//                                        @Override
//                                        public void getCheckconsistentAb() {
//
//                                            for (int i = 0; i <=student_absent_list.getChildCount(); i++) {
//                                                View view1 = student_absent_list.getChildAt(i);
//                                                if (view1 != null) {
